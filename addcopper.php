...
// Парамтеры
$customer = '';
// Заказчик  тут обозначаю потому что при вызове движка будут 
// переписаны из $_GET, а warnings будет меньше
$board = ''; // Плата
...
if (empty($rs)) {
    ...
    echo "copy /Y .\\$drillname.mk2 k:\\" . $rs [0] . 
                ($mpp != - 1 ? "\\MPP" : "") . "\\\n";
    echo "copy /Y .\\$drillname.mk4 k:\\" . $rs [0] . 
                ($mpp != - 1 ? "\\MPP" : "") . "\\\n";
    echo "copy /Y .\\$drillname.frz k:\\" . $rs [0] . 
                ($mpp != - 1 ? "\\MPP" : "") . "\\\n";
}
?>