<?
/*
 * Добавляет данные электроконтроля
 */
// Парамтеры
$customer=''; //Заказчик  тут обозначаю потому что при вызове движка будут переписаны из $_GET, а warnings будет меньше
$board=''; // Плата
$type=$points=$pib=$pointsb=$factor=$numcomp=$sizex=$sizey=$numpl='';
// соответственно тип, количество точек, плат в блоке, точек в блоке, коэффициэнт сложности, количество, разме, размер, количество плат
