<?
/*
 * Дата для других функции CMS (c) Osmio
 */
...
$_SERVER [months] = array ("ru" => array (CMSDATE_MOD_DEFAULT => array ("", "Января", "Февраля", "Марта", "Апреля", "Мая", "Июня", "Июля", "Августа", "Сентября", "Октября", "Ноября", "Декабря" ), CMSDATE_MOD_WORD => array ("", "Январь", "Февраль", "Март", "Апрель", "Май", "Июнь", "Июль", "Август", "Сентябрь", "Октябрь", "Ноябрь", "Декабрь" ), CMSDATE_MOD_CUT => array ("", "Янв", "Фев", "Мар", "Апр", "Мая", "Июн", "Июл", "Авг", "Сен", "Окт", "Ноя", "Дек" ) ), "en" => array (CMSDATE_MOD_DEFAULT => array ("", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December" ), CMSDATE_MOD_WORD => array ("", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December" ), CMSDATE_MOD_CUT => array ("", "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" ) ) );
