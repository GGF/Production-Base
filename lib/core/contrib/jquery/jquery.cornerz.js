...
;(function($){
  ...
  $.fn.cornerz = function(options){
    ...
    function vmlCurve(r,b,c,m,ml,mt, right_fix) {
        ...
        var t = m-mt;
				var cls = c.substr(0, 1) == "#" ? "jquery-cornerz-arc" : ""; // DIS WUZ HERE!
        return "<v:arc class='"+cls+"' filled='False' strokeweight='"+b+"px' strokecolor='"+c+"' startangle='0' endangle='361' style=' top:" + t +"px;left: "+ l + ";width:" + r+ "px; height:" + r+ "px' />";
    }
