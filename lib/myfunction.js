...
function yellowtr() {
	$('.nechettr').live('hover',function(){ $('#'+curtr).toggleClass('yellow');$(this).toggleClass('yellow');curtr=$(this).attr('id');});
	$('.chettr').live('hover',function(){ $('#'+curtr).toggleClass('yellow');$(this).toggleClass('yellow');curtr=$(this).attr('id');});
	$('#editdiv').live('focus',function() {
