...
elseif (isset($edit))
{
	...
	//echo $sql;
	$rs=sql::fetchOne($sql);
	echo "<a class=under href=zap.php?print=tz&id=".$rs[id]." title='Открыть ТЗ (локальную копию)'>ТЗ - $rs[id]</a>";
	$r = getright();
	if ($r["zap"]["edit"]) {
